...
# from http://www.math.uiuc.edu/~gfrancis/illimath/windows/aszgard_mini/movpy-2.0.0-py2.4.4/movpy/lib/win32/lib
# /win32con.py
...
def grab_screen(region=None):
    ...
    bitmap = None
    try:
        screen = CreateDC(c_char_p('DISPLAY'.encode()), NULL, NULL, NULL)
